...
class ObjectType extends Component {
  constructor(props) {
    ...
    this.state = {
      open: props.value instanceof window.ExpandedObject ? true : props.open,
    };
  }
  ...
  render() {
    ...
    displayName = this.props.value instanceof window.ExpandedObject && 'Object';

    if (!displayName) {
      displayName = (value.constructor ? value.constructor.name : 'Object') || 'Object';
    }
